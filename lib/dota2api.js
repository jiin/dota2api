...
Dota2Api.prototype.getMatchDetails = function(id, cb) {
	...
	this.request('IDOTA2Match_570', 'GetMatchDetails', config, function (err, result) {
		cb(err, result);
	});
}
...
Dota2Api.prototype.getMatchHistory = function(config, cb) {
	...
	this.request('IDOTA2Match_570', 'getMatchHistory', config, function (err, result) {
		cb(err, result);
	});
}
...
Dota2Api.prototype.getHeroes = function(cb) {
	...
	this.request('IEconDOTA2_570', 'GetHeroes', config, function (err, result) {
		cb(err, result);
	});
}
